from project04restaurant.beverage.beverage import Beverage
from project04restaurant.food.soup import Soup
from project04restaurant.product import Product
